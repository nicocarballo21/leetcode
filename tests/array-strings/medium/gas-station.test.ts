import fn from '@challenges/array-strings/medium/gas-station'
import { describe, test, expect } from 'vitest'

describe('134 - Gas station', () => {
  test('a', () => {
    expect(fn([1, 2, 3, 4, 5], [3, 4, 5, 1, 2])).toBe(3)
  })
  test('b', () => {
    expect(fn([2, 3, 4], [3, 4, 3])).toBe(-1)
  })
  test('c', () => {
    expect(fn([5, 1, 2, 3, 4], [4, 4, 1, 5, 1])).toBe(4)
  })
  test('d', () => {
    expect(fn([5, 8, 2, 8], [6, 5, 6, 6])).toBe(3)
  })
  test('e', () => {
    expect(fn([2], [2])).toBe(0)
  })
  test('f', () => {
    expect(fn([1, 2], [2, 1])).toBe(1)
  })
  test('g', () => {
    expect(fn(
